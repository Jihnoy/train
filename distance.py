...
def drawing_output(frame, model, encoder, depth_decoder):
    ...
    y = model_yolov7(frame_temp, model)
...
if __name__ == '__main__':
    model = torch.hub.load("", 'custom', 'crowdHuman.pt', source='local')
    ...
    #
    cap = cv.VideoCapture("runs/detect/exp52/0.mp4")
    pre_timeframe = 0
    new_timeframe = 0
